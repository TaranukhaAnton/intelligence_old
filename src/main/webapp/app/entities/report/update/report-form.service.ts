...
type ReportFormGroupContent = {
  ...
  path: FormControl<ReportFormRawValue['path']>;
  resourceId: FormControl<ReportFormRawValue['resourceId']>;
  conclusion: FormControl<ReportFormRawValue['conclusion']>;
  content: FormControl<ReportFormRawValue['content']>;
  contentContentType: FormControl<ReportFormRawValue['contentContentType']>;
};
...
export class ReportFormService {
  createReportFormGroup(report: ReportFormGroupInput = { id: null }): ReportFormGroup {
    ...
    return new FormGroup<ReportFormGroupContent>({
      ...
      path: new FormControl(reportRawValue.path),
      resourceId: new FormControl(reportRawValue.resourceId),
      conclusion: new FormControl(reportRawValue.conclusion),
      content: new FormControl(reportRawValue.content),
      contentContentType: new FormControl(reportRawValue.contentContentType),
    });
  }
