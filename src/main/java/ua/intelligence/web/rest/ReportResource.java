...
/**
 * REST controller for managing {@link ua.intelligence.domain.Report}.
 */
@RestController
@RequestMapping("/api")
public class ReportResource {
    ...
    @ResponseBody
    public ResponseEntity<Resource> serveFile(@PathVariable(value = "id") final Long id) {
        final byte[] bytes = reportService.generateReport(id);
        if (bytes == null) {
