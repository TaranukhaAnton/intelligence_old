...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, ua.intelligence.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, ua.intelligence.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, ua.intelligence.domain.User.class.getName());
            createCache(cm, ua.intelligence.domain.Authority.class.getName());
